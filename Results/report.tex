...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=\textheight]{uml.png}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{p3_portfolios_monthly_price_plot.png}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{p3_portfolios_annual_return_plot.png}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{pb_portfolios_monthly_price_plot.png}
\caption{Portfolio Value}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{pb_2017_stocks_returns.png}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{p1_bonds_plot.png}
\caption{Bonds over 50 years}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.7\textwidth,height=\textheight]{p2_stocks_plot.png}
